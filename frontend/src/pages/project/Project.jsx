...
import { X, Eye, Edit, Trash2, Building, ReceiptText, Search, Calendar, CheckCircle, FolderOpen, XCircle } from "lucide-react";
...
const Projects = () => {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            setAlertMessage("The project has been moved to the trash!");
        ...
        <ProjectLayout>
            <div className="m-3 flex flex-col gap-3">
                <div className="flex items-center justify-between mb-2.5">
                    <h1 className="text-2xl font-semibold pb-4">Project</h1>
                    ...
                    >
                        ...
                        <div className="relative bg-white rounded-2xl w-full max-w-md mx-4 z-50 shadow-xl">
                            ...
                            <div className="px-6 py-5">
                                <p className="text-gray-700">Are you sure want to delete this project?</p>
